...
\begin{figure}[H]
	...
	\centerline{
		\includegraphics[width=0.75\textwidth]{Stats/expanded_relationship.pdf}
	}
...
\begin{figure}[H]
	\hfill
	\subfigure[BFS]{\includegraphics[width=0.45\textwidth]{Stats/Breadth-First-hist-path_length.pdf}}
	\hfill
	\subfigure[DFS]{\includegraphics[width=0.45\textwidth]{Stats/Depth-First-hist-path_length.pdf}}
...
\begin{figure}[H]
	\hfill
	\subfigure[Mean run-times]{\includegraphics[width=0.45\textwidth]{Stats/runtime_bars.pdf}}
	\hfill
	\subfigure[Mean nodes expanded]{\includegraphics[width=0.45\textwidth]{Stats/expanded_bars.pdf}}
...
\begin{figure}[H]
	...
	\centerline{
		\includegraphics[width=0.7\textwidth]{Stats/Iterative-Deepening A*-bar-nodes_expanded.pdf}
	}
...
\begin{figure}[H]
	...
	\centerline{
		\includegraphics[width=0.7\textwidth]{Stats/Iterative-Deepening A*-bar-execution_time.pdf}
	}
